...
pub use protocol::ExecScratchScope;
...
pub use read_only_scratch::READ_ONLY_SCRATCH_DIR_ENV_VAR;
pub use read_only_scratch::ReadOnlyScratchConfig;
pub use read_only_scratch::ReadOnlyScratchManager;
pub use read_only_scratch::ReadOnlyScratchScope;
